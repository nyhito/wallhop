– Cerber X V1.1 (Made by nyhito) – All Credits: nyhito (tester, config
and uploader) – The Best Flee the Facility Script

local Players = game:GetService(“Players”) local TweenService =
game:GetService(“TweenService”) local UserInputService =
game:GetService(“UserInputService”) local GuiService =
game:GetService(“GuiService”) local RunService =
game:GetService(“RunService”) local HttpService =
game:GetService(“HttpService”) local TextChatService =
game:GetService(“TextChatService”)

local CERBER_ICON_IMAGE = “rbxassetid://98605939008332”

local LocalPlayer = Players.LocalPlayer local PlayerGui =
LocalPlayer:WaitForChild(“PlayerGui”) local Camera =
workspace.CurrentCamera

local GLOBAL_WALLHOP_TOKEN_NAME = “__nyhito_ftf_wallhop_active_token”
local ACTIVE_SCRIPT_TOKEN = tostring(os.clock()) .. “_” ..
tostring(math.random(100000, 999999))

pcall(function() if getgenv then getgenv()[GLOBAL_WALLHOP_TOKEN_NAME] =
ACTIVE_SCRIPT_TOKEN else _G[GLOBAL_WALLHOP_TOKEN_NAME] =
ACTIVE_SCRIPT_TOKEN end end)

local function isThisScriptActive() local ok, value = pcall(function()
if getgenv then return getgenv()[GLOBAL_WALLHOP_TOKEN_NAME] end return
_G[GLOBAL_WALLHOP_TOKEN_NAME] end)
...
local DEFAULT_HIDE_GUI_KEY = Enum.KeyCode.RightShift local
DEFAULT_TOGGLE_SCRIPT_KEY = Enum.KeyCode.Y local
DEFAULT_TOGGLE_BEAST_SLOW_KEY = Enum.KeyCode.I local
DEFAULT_TOGGLE_CORNER_WALK_KEY = Enum.KeyCode.R local
DEFAULT_TOGGLE_XRAY_KEY = Enum.KeyCode.X local
DEFAULT_TOGGLE_NON_SPAM_KEY = Enum.KeyCode.U local
DEFAULT_TOGGLE_CLIP_DANCE2_KEY = Enum.KeyCode.P local
DEFAULT_TOGGLE_FLOORBANG_ESP_KEY = Enum.KeyCode.F

local KEYBINDS_FILE = “nyhito_ftf_wallhop_keybinds.json” local
PREFS_FILE = “nyhito_ftf_wallhop_prefs.json”

selectedMode = nil

hideGuiKey = DEFAULT_HIDE_GUI_KEY toggleScriptKey =
DEFAULT_TOGGLE_SCRIPT_KEY toggleBeastSlowKey =
DEFAULT_TOGGLE_BEAST_SLOW_KEY toggleCornerWalkKey =
DEFAULT_TOGGLE_CORNER_WALK_KEY toggleXrayKey = DEFAULT_TOGGLE_XRAY_KEY
toggleNonSpamKey = DEFAULT_TOGGLE_NON_SPAM_KEY toggleClipDance2Key =
DEFAULT_TOGGLE_CLIP_DANCE2_KEY toggleFloorbangEspKey =
DEFAULT_TOGGLE_FLOORBANG_ESP_KEY

waitingForHideKey = false waitingForToggleKey = false
waitingForBeastSlowKey = false waitingForCornerWalkKey = false
waitingForXrayKey = false waitingForNonSpamKey = false
waitingForClipDance2Key = false waitingForFloorbangEspKey = false

guiVisible = true guiMinimized = false mobileMenuOpen = false
mobileWallhopGuiHidden = false mobileCornerWalkButtonVisible = false
mobileBeastSlowButtonVisible = false

ScreenGui = nil MainFrame = nil MiniButton = nil MobileButton = nil
MobileCornerWalkButton = nil MobileBeastSlowButton = nil
MobileMenuButton = nil MobilePanel = nil ToggleButton = nil
HideGuiBindButton = nil ToggleBindButton = nil BeastSlowBindButton = nil
CornerWalkBindButton = nil XrayBindButton = nil RealXrayBindButton = nil
ClipDance2BindButton = nil FloorbangEspBindButton = nil Notice = nil
NoticeStroke = nil NoticeBar = nil

PcTabFunctions = nil PcTabFlicks = nil PcTabSettings = nil
PcFunctionsPage = nil PcFlicksPage = nil PcSettingsPage = nil
PcMinimalSettingsTitle = nil PcCurrentUsingLabel = nil
PcSettingsXrayTitle = nil PcSettingsNonSpamTitle = nil PcSettingsXrayBox
= nil PcSettingsNonSpamBox = nil PcSettingsNonSpamAfterTitle = nil
PcSettingsNonSpamAfterBox = nil PcDance2TimeTitle = nil PcDance2TimeBox
= nil PcCwalkRangeTitle = nil PcCwalkRangeBox = nil
PcNormalWallhopButton = nil PcNoMoveWallhopButton = nil
Pc360WallhopButton = nil PcConsoleWallhopButton = nil PcFlickTypesTitle
= nil PcFlickSettingsTitle = nil PcNormalFlickButton = nil
PcSpeedFlickButton = nil PcSlowFlickButton = nil

MobileTabFunctions = nil MobileTabFlicks = nil MobileTabSettings = nil
MobileFunctionsPage = nil MobileFlicksPage = nil MobileSettingsPage =
nil MobileMinimalSettingsTitle = nil MobileCurrentUsingLabel = nil
SettingsXrayBox = nil SettingsNonSpamBox = nil SettingsNonSpamAfterTitle
= nil SettingsNonSpamAfterBox = nil SettingsDance2TimeTitle = nil
SettingsDance2TimeBox = nil SettingsCwalkRangeTitle = nil
SettingsCwalkRangeBox = nil MobileNormalWallhopRow = nil
MobileNoMoveWallhopRow = nil Mobile360WallhopRow = nil
MobileConsoleWallhopRow = nil MobileFlickTypesTitle = nil
MobileFlickSettingsTitle = nil MobileNormalFlickRow = nil
MobileSpeedFlickRow = nil MobileSlowFlickRow = nil MobileBeastSlowRow =
nil MobileCornerWalkRow = nil MobileXrayRow = nil MobileRealXrayRow =
nil MobileDance2TurnRow = nil MobileAutoInteractRow = nil
MobileAutoInteractRealRow = nil MobilePlayersESPRow = nil
MobileFloorbangEspRow = nil MobileHideGuiRow = nil

mobileBeastSlowSwitch = nil mobileBeastSlowKnob = nil
mobileCornerWalkSwitch = nil mobileCornerWalkKnob = nil mobileXraySwitch
= nil mobileXrayKnob = nil mobileRealXraySwitch = nil mobileRealXrayKnob
= nil mobileDance2TurnSwitch = nil mobileDance2TurnKnob = nil
mobileAutoInteractSwitch = nil mobileAutoInteractKnob = nil
mobileAutoInteractRealSwitch = nil mobileAutoInteractRealKnob = nil
mobilePlayersESPSwitch = nil mobilePlayersESPKnob = nil
mobileFloorbangEspSwitch = nil mobileFloorbangEspKnob = nil
mobileHideGuiSwitch = nil mobileHideGuiKnob = nil mobileDragHandle = nil

local dragConnections = {} local shadowRegistry = {}

clearScriptSlowInstant = nil updateMobilePanelButtons = nil
setMobileWallhopVisualHidden = nil setMobileCornerWalkButtonVisible =
nil setMobileBeastSlowButtonVisible = nil applyVisibility = nil
updateFlickButtons = nil switchPcTab = nil switchMobileTab = nil
...
false dance2NoclipOriginalCanCollide = {} allowThirdPersonEnabled = true
xrayOpacityValue = 60 nonSpamValue = 50 nonSpamAfterValue = 0
dance2TimeValue = 10 cwalkRangeValue = 1 consecutiveWallhopCount = 0
isFlicking = false lastFlickTime = 0

isWallHopping = false lastWallHopTime = 0 WALLHOP_GRACE_TIME = 1.5
WALLHOP_COOLDOWN = 0

blockDoubleJump = false

lastHitPosition = nil MIN_HIT_DISTANCE = 0.1 lastFlickAngle = nil

airborneSource = nil airborneStartY = nil airborneStartTime = 0
jumpedRecently = false

LEDGE_BLOCK_DISTANCE = 6.0 LEDGE_BLOCK_TIME = 0.20

SLOW_DURATION = 0.8 SLOW_WALKSPEED = 9 DEFAULT_WALKSPEED = 16 slowToken
= 0 scriptSlowActive = false

FIRST_FLICK_RESET_GROUND_TIME = 3 lastLandedTime = 0
hasWallhoppedSinceLanding = false specialFirstFlickArmed = false

currentFlickMode = “Normal Wallhop” currentFlickSetting = “Normal Flick”
next360Direction = 1

local function destroyOld()

local function playIntroSound() task.spawn(function() pcall(function()
local soundGui = PlayerGui:FindFirstChild(“WallhopIntroSoundGui”) if
soundGui then soundGui:Destroy() end
...
pcall(function() local oldFloor =
workspace:FindFirstChild(“CornerWalkArtificialFloor”) if oldFloor then
oldFloor:Destroy() end end)
...
local function getKeyCodeFromName(name, fallback) if typeof(name) ~=
“string” then return fallback end
...
local function savePCKeybinds() if not writefile then return end
...
local function loadPCKeybinds() if not readfile or not isfile then
return end
...
local function saveUserPreferences() if not writefile then return end
...
local function loadUserPreferences() if not readfile or not isfile or
not isfile(PREFS_FILE) then return end
...
local function allowThirdPersonAccess() if not allowThirdPersonEnabled
then return end
...
RunService.RenderStepped:Connect(function() if isThisScriptActive and
not isThisScriptActive() then return end

    allowThirdPersonAccess()

end)

local function restoreDance2Noclip() for part, oldValue in
pairs(dance2NoclipOriginalCanCollide) do if part and part.Parent then
pcall(function() part.CanCollide = oldValue end) end end
...
local function isDance2AnimationPlaying() local char =
LocalPlayer.Character local hum = char and
char:FindFirstChildOfClass(“Humanoid”) if not hum then return false end
...
local function startDance2Noclip(token) if token ~= dance2TurnToken or
not isDance2TurnEnabled then return end
...
local function runDance2TurnSequence() if not isDance2TurnEnabled then
return end
...
local function setDance2TurnEnabled(state) isDance2TurnEnabled = state
and true or false
...
local function isDance2Command(message) local msg = tostring(message or
““):lower() msg = msg:gsub(”^%s+“,”“):gsub(”%s+$“,”“) return msg ==”/e
dance2” or msg == “/emote dance2” or msg == “dance2” end

LocalPlayer.Chatted:Connect(function(message) if
isDance2Command(message) then runDance2TurnSequence() end end)

pcall(function()
TextChatService.SendingMessage:Connect(function(message) local text =
message and (message.Text or message.TextSource or ““) if
isDance2Command(text) then runDance2TurnSequence() end end) end)

local function noTextStroke(obj) obj.TextStrokeTransparency = 1 end

local function registerShadow(host, shadow) shadowRegistry[host] =
shadowRegistry[host] or {} table.insert(shadowRegistry[host], shadow)
end

local function setHostShadowVisible(host, visible) local list =
shadowRegistry[host] if not list then return end
...
local function setTargetTransparency(obj, bg, text) if bg ~= nil then
obj:SetAttribute(“TargetBGTransparency”, bg) end if text ~= nil then
obj:SetAttribute(“TargetTextTransparency”, text) end end

local function getTargetBG(obj) local v =
obj:GetAttribute(“TargetBGTransparency”) if typeof(v) == “number” then
return v end return obj.BackgroundTransparency end

local function getTargetText(obj) local v =
obj:GetAttribute(“TargetTextTransparency”) if typeof(v) == “number” then
return v end return obj.TextTransparency end

local function addTrueRoundedShadow(parent, cornerRadius, strength,
shadowColor) strength = strength or 1 shadowColor = shadowColor or
...
local function elegantShow(root, finalSize, finalPosition,
finalBgTransparency) if not root then return end
...
local function elegantHide(root, onDone) if not root then if onDone then
onDone() end return end
...
local activeNoticeId = 0 local function showNotice(text) if selectedMode
~= “PC” or not Notice or not NoticeStroke or not NoticeBar then return
end
...
local function canUseMobileTap(obj) local lastDragTime =
obj:GetAttribute(“LastDragTime”) if typeof(lastDragTime) == “number”
then return (tick() - lastDragTime) > 0.12 end return true end

local function bindRowPress(button, callback) local activeInput = nil
local startPos = nil local moved = false local lastTap = 0
...
local function updateSwitchVisual(switchFrame, knob, enabled) if not
switchFrame or not knob then return end
...
local function createSwitchRow(parent, yOffset, labelText) local row =
Instance.new(“TextButton”) row.Size = UDim2.new(1, -14, 0, 40)
row.Position = UDim2.new(0, 7, 0, yOffset) row.BackgroundColor3 =
Color3.fromRGB(0, 0, 0) row.AutoButtonColor = false row.Text = “”
row.BorderSizePixel = 0 row.Parent = parent row.ZIndex = 5 row.Active =
true row.Selectable = false Instance.new(“UICorner”, row).CornerRadius =
UDim.new(0, 12) setTargetTransparency(row, 0, 1)
...
local function createSimpleRow(parent, yOffset, labelText) local row =
Instance.new(“TextButton”) row.Size = UDim2.new(1, -14, 0, 40)
row.Position = UDim2.new(0, 7, 0, yOffset) row.BackgroundColor3 =
Color3.fromRGB(0, 0, 0) row.AutoButtonColor = false row.Text = “”
row.BorderSizePixel = 0 row.Parent = parent row.ZIndex = 5 row.Active =
...
local function updateToggleButton() if selectedMode == “PC” and
ToggleButton then ToggleButton.Text = isWallHopEnabled and “Wall Hop On”
or “Wall Hop Off” elseif selectedMode == “Mobile” then if MobileButton
then MobileButton.Text = isWallHopEnabled and “Wallhop On” or “Wallhop
Off” end if MobileCornerWalkButton then MobileCornerWalkButton.Text =
isCornerWalkEnabled and “C-walk On” or “C-walk Off” end if
MobileBeastSlowButton then MobileBeastSlowButton.Text = isSlowEnabled
and “Slow On” or “Slow Off” end end end

setMobileWallhopVisualHidden = function(hidden) if not MobileButton then
return end MobileButton.BackgroundTransparency = hidden and 1 or 0
MobileButton.TextTransparency = hidden and 1 or 0
setHostShadowVisible(MobileButton, not hidden) end

setMobileCornerWalkButtonVisible = function(visible) if not
MobileCornerWalkButton then return end
...
setMobileBeastSlowButtonVisible = function(visible) if not
MobileBeastSlowButton then return end
...
function setFlickSetting(settingName) if settingName ~= “Normal Flick”
and settingName ~= “Speed Flick” and settingName ~= “Slow Flick” then
settingName = “Normal Flick” end
...
updateFlickButtons = function() if PcCurrentUsingLabel then
PcCurrentUsingLabel.Text = “Currently config:” .. currentFlickMode ..
“,” .. currentFlickSetting end
...
local instaInteractTargets = {} local instaInteractOriginalHoldDurations
= {}

local function cacheInstaInteractTarget(obj) if obj and
obj:IsA(“ProximityPrompt”) then instaInteractTargets[obj] = true end end

local function scanInstaInteractTargets()
table.clear(instaInteractTargets)
...
local function applyInstaInteractToPrompt(prompt) if not prompt or not
prompt.Parent or not prompt:IsA(“ProximityPrompt”) then
instaInteractTargets[prompt] = nil return end

    if instaInteractOriginalHoldDurations[prompt] == nil then
        instaInteractOriginalHoldDurations[prompt] = prompt.HoldDuration
    end
...
local function applyInstaInteract() for prompt in
pairs(instaInteractTargets) do applyInstaInteractToPrompt(prompt) end
end

local function restoreInstaInteractPrompts() for prompt, oldHoldDuration
in pairs(instaInteractOriginalHoldDurations) do if prompt and
prompt.Parent and prompt:IsA(“ProximityPrompt”) then pcall(function()
prompt.HoldDuration = oldHoldDuration end) end end

    table.clear(instaInteractOriginalHoldDurations)

end

local function setInstaInteractEnabled(state) isInstaInteractEnabled =
state and true or false

    if isInstaInteractEnabled then
        scanInstaInteractTargets()
        applyInstaInteract()
    else
        restoreInstaInteractPrompts()
    end
...
cacheInstaInteractTarget(obj)
    ...
    if isInstaInteractEnabled and obj:IsA("ProximityPrompt") then
        task.defer(function()
            applyInstaInteractToPrompt(obj)
        end)
    end

end)

workspace.DescendantRemoving:Connect(function(obj) if
instaInteractTargets[obj] then instaInteractTargets[obj] = nil end

    if instaInteractOriginalHoldDurations[obj] ~= nil then
        instaInteractOriginalHoldDurations[obj] = nil
    end
...
local function removePlayersESP(player) local highlight =
playerESPHighlights[player] if highlight then pcall(function()
highlight:Destroy() end) end

    playerESPHighlights[player] = nil

end

local function clearPlayersESP() for player in
pairs(playerESPHighlights) do removePlayersESP(player) end end

local function createOrUpdatePlayersESP(player) if not
isPlayersESPEnabled or not player or player == LocalPlayer then return
end
...
local function updatePlayersESP() if not isPlayersESPEnabled then
clearPlayersESP() return end
...
local function setPlayersESPEnabled(state) isPlayersESPEnabled = state
and true or false
...
player.CharacterAdded:Connect(function() task.wait(0.25) if
isPlayersESPEnabled then createOrUpdatePlayersESP(player) end end) end)

Players.PlayerRemoving:Connect(function(player) removePlayersESP(player)
end)

for _, player in ipairs(Players:GetPlayers()) do if player ~=
LocalPlayer then player.CharacterAdded:Connect(function()
task.wait(0.25) if isPlayersESPEnabled then
createOrUpdatePlayersESP(player) end end) end end

RunService.Heartbeat:Connect(function() if isThisScriptActive and not
isThisScriptActive() then clearPlayersESP() return end
...
updateMobilePanelButtons = function() if MobileHideGuiRow and
MobileHideGuiRow:FindFirstChild(“Label”) then
MobileHideGuiRow.Label.Text = “Wallhop” end if MobileCornerWalkRow and
MobileCornerWalkRow:FindFirstChild(“Label”) then
MobileCornerWalkRow.Label.Text = “Corner Walk” end if MobileXrayRow and
MobileXrayRow:FindFirstChild(“Label”) then MobileXrayRow.Label.Text =
“Non-spam” end if MobileDance2TurnRow and
MobileDance2TurnRow:FindFirstChild(“Label”) then
MobileDance2TurnRow.Label.Text = “Clip Dance2” end if
MobileAutoInteractRow and MobileAutoInteractRow:FindFirstChild(“Label”)
then MobileAutoInteractRow.Label.Text = “Insta-interact” end if
MobilePlayersESPRow and MobilePlayersESPRow:FindFirstChild(“Label”) then
MobilePlayersESPRow.Label.Text = “Players ESP” end if
MobileNormalWallhopRow and
MobileNormalWallhopRow:FindFirstChild(“Label”) then
MobileNormalWallhopRow.Label.Text = “Normal Wallhop” end if
MobileNoMoveWallhopRow and
MobileNoMoveWallhopRow:FindFirstChild(“Label”) then
MobileNoMoveWallhopRow.Label.Text = “Visual Wallhop” end if
Mobile360WallhopRow and Mobile360WallhopRow:FindFirstChild(“Label”) then
Mobile360WallhopRow.Label.Text = “360° Wallhop” end if
MobileConsoleWallhopRow and
MobileConsoleWallhopRow:FindFirstChild(“Label”) then
MobileConsoleWallhopRow.Label.Text = “Console Wallhop” end
...
local function updateBindButtons() if selectedMode ~= “PC” then return
end
...
applyVisibility = function() if selectedMode == “PC” then if MainFrame
then MainFrame.Visible = guiVisible and not guiMinimized
setHostShadowVisible(MainFrame, guiVisible and not guiMinimized) end if
MiniButton then MiniButton.Visible = guiVisible and guiMinimized
setHostShadowVisible(MiniButton, guiVisible and guiMinimized) end elseif
selectedMode == “Mobile” then if MobileButton then MobileButton.Visible
= guiVisible and not mobileWallhopGuiHidden end if
MobileCornerWalkButton then MobileCornerWalkButton.Visible = guiVisible
and mobileCornerWalkButtonVisible end if MobileMenuButton then
MobileMenuButton.Visible = true end if MobilePanel then
MobilePanel.Visible = mobileMenuOpen setHostShadowVisible(MobilePanel,
mobileMenuOpen) end setMobileWallhopVisualHidden(mobileWallhopGuiHidden)
setMobileCornerWalkButtonVisible(guiVisible and
mobileCornerWalkButtonVisible) end end

local function setGuiVisible(state) guiVisible = state applyVisibility()
showNotice(state and “GUI shown” or “GUI hidden”) end

local function setFlickMode(name) currentFlickMode = name
updateFlickButtons() saveUserPreferences() if selectedMode == “PC” then
showNotice(“Using” .. name) end end

local function createModeSelector(onPick) local selectorGui =
Instance.new(“ScreenGui”) selectorGui.Name = “WallhopModeSelector”
selectorGui.ResetOnSpawn = false selectorGui.ZIndexBehavior =
Enum.ZIndexBehavior.Sibling selectorGui.Parent = PlayerGui
...
local function clearOldDragConnections() for _, c in
ipairs(dragConnections) do if c and c.Disconnect then c:Disconnect() end
end table.clear(dragConnections) end

local function bindFreeDrag(handle, target, onMove, holdTime) local
activeInput = nil local dragStart = nil local startPos = nil local
holdSatisfied = false local holdCanceled = false local holdId = 0
...
switchPcTab = function(name) if not PcFunctionsPage or not PcFlicksPage
or not PcSettingsPage or not PcTabFunctions or not PcTabFlicks or not
PcTabSettings then return end
...
switchMobileTab = function(name) if not MobileFunctionsPage or not
MobileFlicksPage or not MobileSettingsPage or not MobileTabFunctions or
not MobileTabFlicks or not MobileTabSettings then return end
...
local function setSlowEnabled(state) isSlowEnabled = state and true or
false
...
local function setCornerWalkEnabled(state) isCornerWalkEnabled = state
and true or false updateMobilePanelButtons() saveUserPreferences() end

local function setMobileGuiHidden(state) mobileWallhopGuiHidden = state
and true or false updateMobilePanelButtons() saveUserPreferences() end

local function setMobileCornerWalkButtonState(state)
mobileCornerWalkButtonVisible = state and true or false
updateMobilePanelButtons() saveUserPreferences() end

local function setMobileBeastSlowButtonState(state)
mobileBeastSlowButtonVisible = state and true or false
updateMobilePanelButtons() saveUserPreferences() end

function showSettingsNotice(message) if not ScreenGui then return end
...
function getCwalkRangeDistance(value) value = tonumber(value) or 1 if
value <= 1 then return 1.08 end if value == 2 then return 1.22 end if
value == 3 then return 1.36 end if value == 4 then return 1.45 end
return 1.57 end

function setCwalkRangeValue(value) cwalkRangeValue =
math.clamp(math.floor(tonumber(value) or 1), 1, 5)
CORNER_WALK_WALL_DISTANCE = getCwalkRangeDistance(cwalkRangeValue) end

function getNumberFromSettingBox(box) local raw = tostring(box and
box.Text or ““) local num = tonumber(raw) or
tonumber(raw:match(”[-]?%d+“)) return num end

function getEffectiveWallhopCooldown() if not isXrayEnabled then return
0 end
...
function applyCurrentNonSpamCooldown() WALLHOP_COOLDOWN =
getEffectiveWallhopCooldown() end

function updateSettingsInputs() if SettingsNonSpamBox then
SettingsNonSpamBox.Text = tostring(math.floor(tonumber(nonSpamValue) or
50)) .. “ms” SettingsNonSpamBox.TextTransparency = 0
SettingsNonSpamBox.BackgroundTransparency = 0 end if
PcSettingsNonSpamBox then PcSettingsNonSpamBox.Text =
tostring(math.floor(tonumber(nonSpamValue) or 50)) .. “ms”
PcSettingsNonSpamBox.TextTransparency = 0
PcSettingsNonSpamBox.BackgroundTransparency = 0 end if
SettingsNonSpamAfterBox then SettingsNonSpamAfterBox.Text =
tostring(math.floor(tonumber(nonSpamAfterValue) or 0)) .. “wh”
SettingsNonSpamAfterBox.TextTransparency = 0
SettingsNonSpamAfterBox.BackgroundTransparency = 0 end if
PcSettingsNonSpamAfterBox then PcSettingsNonSpamAfterBox.Text =
tostring(math.floor(tonumber(nonSpamAfterValue) or 0)) .. “wh”
PcSettingsNonSpamAfterBox.TextTransparency = 0
PcSettingsNonSpamAfterBox.BackgroundTransparency = 0 end if
SettingsDance2TimeBox then SettingsDance2TimeBox.Text =
tostring(math.floor(tonumber(dance2TimeValue) or 10)) .. “ms”
SettingsDance2TimeBox.TextTransparency = 0
SettingsDance2TimeBox.BackgroundTransparency = 0 end if PcDance2TimeBox
then PcDance2TimeBox.Text =
tostring(math.floor(tonumber(dance2TimeValue) or 10)) .. “ms”
PcDance2TimeBox.TextTransparency = 0
PcDance2TimeBox.BackgroundTransparency = 0 end if SettingsCwalkRangeBox
then SettingsCwalkRangeBox.Text =
tostring(math.floor(tonumber(cwalkRangeValue) or 1)) .. “sd”
SettingsCwalkRangeBox.TextTransparency = 0
SettingsCwalkRangeBox.BackgroundTransparency = 0 end if PcCwalkRangeBox
then PcCwalkRangeBox.Text =
tostring(math.floor(tonumber(cwalkRangeValue) or 1)) .. “sd”
PcCwalkRangeBox.TextTransparency = 0
PcCwalkRangeBox.BackgroundTransparency = 0 end for _, lbl in
ipairs({MobileMinimalSettingsTitle, SettingsNonSpamTitle,
SettingsNonSpamAfterTitle, SettingsDance2TimeTitle,
SettingsCwalkRangeTitle, PcMinimalSettingsTitle, PcSettingsNonSpamTitle,
PcSettingsNonSpamAfterTitle, PcDance2TimeTitle, PcCwalkRangeTitle}) do
if lbl then lbl.TextTransparency = 0 lbl.Visible = true end end end

function applyXraySettingFromBox(sourceBox) local activeBox = sourceBox
or SettingsXrayBox or PcSettingsXrayBox value =
getNumberFromSettingBox(activeBox) if not value or value < 0 or value >
100 then showSettingsNotice(“Minimum value is 0 and the maximum value is
100.”) updateSettingsInputs() return end
...
function applyNonSpamSettingFromBox(sourceBox) local activeBox =
sourceBox or SettingsNonSpamBox or PcSettingsNonSpamBox value =
getNumberFromSettingBox(activeBox) if not value or value < 10 or value >
99 then showSettingsNotice(“Minimum value is 10 and the maximum value is
99.”) updateSettingsInputs() return end
...
function applyNonSpamAfterSettingFromBox(sourceBox) local activeBox =
sourceBox or SettingsNonSpamAfterBox or PcSettingsNonSpamAfterBox value
= getNumberFromSettingBox(activeBox) if not value or value < 0 or
value > 10 then showSettingsNotice(“Minimum value is 0 and the maximum
value is 10.”) updateSettingsInputs() return end
...
function getDance2TimeSeconds() return
math.clamp((tonumber(dance2TimeValue) or 10) / 100, 0.05, 0.20) end

function applyDance2TimeSettingFromBox(sourceBox) local activeBox =
sourceBox or SettingsDance2TimeBox or PcDance2TimeBox value =
getNumberFromSettingBox(activeBox) if not value or value < 5 or value >
20 then showSettingsNotice(“Minimum value is 5 and the maximum value is
20.”) updateSettingsInputs() return end
...
function applyCwalkRangeSettingFromBox(sourceBox) local activeBox =
sourceBox or SettingsCwalkRangeBox or PcCwalkRangeBox value =
getNumberFromSettingBox(activeBox) if not value or value < 1 or value >
5 then showSettingsNotice(“Minimum value is 1 and the maximum value is
5.”) updateSettingsInputs() return end setCwalkRangeValue(value)
updateSettingsInputs() saveUserPreferences()
showSettingsNotice(“Successfully changed, the Corner walk range will be
at” .. tostring(cwalkRangeValue) .. ” studs.”) end

function createSettingsLabel(parent, y, textValue) SettingsLabel =
Instance.new(“TextLabel”) SettingsLabel.Size = UDim2.new(1, -76, 0, 24)
SettingsLabel.Position = UDim2.new(0, 12, 0, y)
SettingsLabel.BackgroundTransparency = 1 SettingsLabel.Text = textValue
SettingsLabel.TextColor3 = Color3.fromRGB(255,255,255)
SettingsLabel.TextTransparency = 0 SettingsLabel.Font =
Enum.Font.GothamBold SettingsLabel.TextSize = 14
SettingsLabel.TextXAlignment = Enum.TextXAlignment.Left
SettingsLabel.TextYAlignment = Enum.TextYAlignment.Center
SettingsLabel.ZIndex = 30 SettingsLabel.Parent = parent
noTextStroke(SettingsLabel) setTargetTransparency(SettingsLabel, 1, 0)
return SettingsLabel end

function addSettingsPressEffect(button) if not button then return end
...
function createSettingsButton(parent, y, textValue) SettingsButton =
Instance.new(“TextButton”) SettingsButton.Size = UDim2.new(1, -14, 0,
32) SettingsButton.Position = UDim2.new(0, 7, 0, y)
SettingsButton.BackgroundColor3 = Color3.fromRGB(0,0,0)
SettingsButton.Text = textValue SettingsButton.TextColor3 =
Color3.fromRGB(255,255,255) SettingsButton.Font = Enum.Font.GothamBold
SettingsButton.TextSize = 13 SettingsButton.AutoButtonColor = false
SettingsButton.ZIndex = 36 SettingsButton.Parent = parent
...
SettingsButtonStroke.Thickness = 1 SettingsButtonStroke.Transparency =
0.08 SettingsButtonStroke.Parent = SettingsButton
noTextStroke(SettingsButton) setTargetTransparency(SettingsButton, 0, 0)
addSettingsPressEffect(SettingsButton) return SettingsButton end

function buildMobileSettingsPage() MobileSettingsPage =
Instance.new(“ScrollingFrame”) MobileSettingsPage.Size = UDim2.new(1, 0,
1, -58) MobileSettingsPage.Position = UDim2.new(0, 0, 0, 58)
...
MobileSettingsPage.Visible = false MobileSettingsPage.Parent =
MobilePanel
...
local function buildMobileGui() clearOldDragConnections()
loadUserPreferences() isSlowEnabled = false realXrayEnabled = false
isFloorbangEspEnabled = false mobileBeastSlowButtonVisible = false
...
local function setMinimized(state) if selectedMode ~= “PC” then return
end
...
local function createPcTabButton(parent, x, text) local button =
Instance.new(“TextButton”) button.Size = UDim2.new(0, 96, 0, 28)
button.Position = UDim2.new(0, x, 0, 54) button.BackgroundColor3 =
Color3.fromRGB(8,8,8) button.Text = text button.TextColor3 =
Color3.fromRGB(255,255,255) button.Font = Enum.Font.GothamBold
button.TextSize = 13 button.AutoButtonColor = false button.Parent =
parent Instance.new(“UICorner”, button).CornerRadius = UDim.new(0, 10)
noTextStroke(button) setTargetTransparency(button, 0, 0) return button
end

local function createPcActionButton(parent, y, text) local button =
Instance.new(“TextButton”) button.Size = UDim2.new(1, -36, 0, 30)
button.Position = UDim2.new(0, 18, 0, y) button.BackgroundColor3 =
Color3.fromRGB(6,6,6) button.Text = text button.TextColor3 =
Color3.fromRGB(255,255,255) button.Font = Enum.Font.GothamBold
button.TextSize = 14 button.AutoButtonColor = false button.Parent =
parent Instance.new(“UICorner”, button).CornerRadius = UDim.new(0, 10)
noTextStroke(button) setTargetTransparency(button, 0, 0) return button
end

local function buildPCGui() clearOldDragConnections() loadPCKeybinds()
loadUserPreferences()
...
clearScriptSlowInstant = function() slowToken = slowToken + 1
...
local function applyWallhopSlow(hum) if not hum or not hum.Parent or not
isSlowEnabled then return end
...
local function isCrouching(hum, hrp) if not hum or not hrp then return
false end
...
local function setupCharacter(char) local hum =
...
local jumpAnimToken = 0 local rotationLockToken = 0 local
activeJumpTrack = nil

local function playWallhopArmPulse(hum) if not hum or not hum.Parent
then return end
...
local function lockBodyRotation(hum, duration) if not hum or not
hum.Parent then return end
...
local function forceWallhopJump(hum) if not hum or not hum.Parent then
return end
...
local function pickNextFlick(useSpecialFirst) local minAngle, maxAngle
...
local function getFlickSettingSpeedScale() if currentFlickSetting ==
“Speed Flick” then return 0.78 elseif currentFlickSetting == “Slow
Flick” then return 1.24 end return 1 end

local function getFlickSettingStepAdd() if currentFlickSetting == “Speed
Flick” then return 0 elseif currentFlickSetting == “Slow Flick” then
return 1 end return 0 end

local function applyFlickSettingProfile(profile) local scale =
getFlickSettingSpeedScale() local stepAdd = getFlickSettingStepAdd()
...
local function getFlickProfile(useSpecialFirst) if useSpecialFirst then
return applyFlickSettingProfile({ goSteps = math.random(3, 4),
goDelayMin = 0.0130, goDelayMax = 0.0165, holdTime = 0.01, returnSteps =
math.random(2, 3), returnDelayMin = 0.0095, returnDelayMax = 0.0120,
overshootMin = 22, overshootMax = 25, overshootBaseDelay = 0.0085 }) end
...
local function getCameraYaw() local look = Camera.CFrame.LookVector
...
task.delay(0.12, function() if myToken ~= rotateToken then return end
...
local function performNormalWallhop() if isFlicking then return end
...
local function apply360FlickSettingProfile(profile) local scale =
getFlickSettingSpeedScale() local stepAdd = currentFlickSetting ==
“Speed Flick” and -1 or currentFlickSetting == “Slow Flick” and 1 or 0
...
local function get360FlickProfile() local flickRoll = math.random()
...
local function perform360Wallhop() if isFlicking then return end
...
local function performNoMoveWallhop() if isFlicking then return end
...
local function performConsoleWallhop() if isFlicking then return end
...
local function performSelectedWallhop() if currentFlickMode == “Console
Wallhop” then performConsoleWallhop() elseif currentFlickMode == “Visual
Wallhop” then performNoMoveWallhop() elseif currentFlickMode == “360°
Wallhop” then perform360Wallhop() else performNormalWallhop() end end

local function isPlayerCharacter(instance) if not instance then return
false end
...
local function isWallLikeSurface(normal) return math.abs(normal.Y) <
0.35 end

local function hasValidHorizontalEdge(rayResult, params) if not
rayResult or not rayResult.Instance then return false end
...
local function findValidWall(hrp, params, directions) local offsets = {
Vector3.new(0, -2.3, 0), Vector3.new(0, -2.2, 0), Vector3.new(0, -2.1,
0) }
...
local look = Vector3.new(cameraLook.X, 0, cameraLook.Z) local normal =
Vector3.new(wallNormal.X, 0, wallNormal.Z)
...
local cornerWalkAirStart = 0 local cornerWalkFloorPart = nil local
lastCornerWalkTouch = 0

local CORNER_WALK_AIR_TIME = 0.03 CORNER_WALK_WALL_DISTANCE = 1.08 local
CORNER_WALK_MIN_MOVE = 0.08 local CORNER_WALK_MIN_REAL_SPEED = 0.45
local CORNER_WALK_FLOOR_THICKNESS = 0.16 local CORNER_WALK_FLOOR_LENGTH
= 4.20 local CORNER_WALK_FLOOR_WIDTH = 0.62

local function flatUnit(vec) if not vec or vec.Magnitude < 0.05 then
return nil end return vec.Unit end

local function removeCornerWalkFloor() if cornerWalkFloorPart then
pcall(function() cornerWalkFloorPart:Destroy() end) end
...
local function getCornerWalkFloor() if cornerWalkFloorPart and
cornerWalkFloorPart.Parent then return cornerWalkFloorPart end
...
local function isCornerWalkStateAllowed(hum) if not hum then return
false end
...
local function getCornerWalkDirections(hrp, hum) local dirs = {}
...
local function findCornerWalkEdge(hrp, hum, params) if not hrp or not
hum then return nil end
...
local function updateCornerWalkFloor(hrp, hum, edgeRay) if not hrp or
not hum or not edgeRay then removeCornerWalkFloor() return end
...
local function runCornerWalk() if not isCornerWalkEnabled then
cornerWalkAirStart = 0 removeCornerWalkFloor() return end
...
RunService.Heartbeat:Connect(function() if not isThisScriptActive() then
removeCornerWalkFloor() restoreDance2Noclip() return end
...
UserInputService.InputBegan:Connect(function(input, gameProcessed) if
not isThisScriptActive() then return end
...
selectedMode = “Mobile” buildMobileGui()

updateToggleButton() updateMobilePanelButtons() updateFlickButtons()
applyVisibility()
